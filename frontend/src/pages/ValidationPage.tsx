        ...
        <div style={{ padding: '20px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', maxWidth: '400px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '5px' }}>
                    <label style={{ fontWeight: 'bold', fontSize: '0.9rem' }}>Configuration ID (UUID)</label>
            ...
            {result && (
                <div style={{ marginTop: '20px', padding: '10px', border: result.is_valid ? '1px solid green' : '1px solid red' }}>
